...
export default function Dashboard() {
  console.log("RAPERStockDASH - Versão Diagnóstico 3.0.1 - VERIFICAR DEPLOY");
        ...
        <div className="flex items-center gap-4 relative z-10 w-full sm:w-auto">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
              Status do Sistema
              <span className="text-[10px] bg-brand-500/20 text-brand-400 px-1.5 py-0.5 rounded border border-brand-500/30">v3.0.1</span>
            </h3>
